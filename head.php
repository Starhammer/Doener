...
<html>
	...
	<body class="text-center">
		<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
			<a class="navbar-brand" href="<?php echo $base."/kundenkonto.php";?>">D&ouml;nerportal</a>
			<div class="navbar-nav">
				<?php if(isset($_SESSION['token'])&&isset($_SESSION['user'])): ?>
					<a class="nav-item nav-link active" href="<?php echo $base."/auftrag.php";?>">Bestellen <span class="sr-only">(current)</span></a>
				...
				<?php else: ?>					
					<a class="nav-item nav-link active" href="<?php echo $base."/register.php";?>">Registrieren</a>
					<a class="nav-item nav-link" href="<?php echo $base."/index.php";?>">Login</a>
				<?php endif; ?>				
			</div>
		</nav>
<!--END head.php-->